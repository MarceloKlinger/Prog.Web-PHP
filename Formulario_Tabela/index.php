...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $items_list = (string)$_POST['items_list'];
...
<body class="min-h-screen flex items-center justify-center bg-blue-400">
  <div class="bg-white p-16 rounded shadow-2x1 w-2/3">
    <h2 class="text-center text-2xl text-gray-800 pb-8">Formulário de contato</h2>
    <form action="index.php" method="post" class="space-y-3">
      ...
      <button class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" type="submit" value="enviar">ENVIAR</button>
    </form>
  </div>
</body>
